...
var MajhPlayer = require('ybmjPlayer');
var majhMsgQueue = require('ybmjMsgQueue');
var mjBackPlay = require('ybmjBackPlay');
let mjAudio = require('ybmjAudio');
...
cc.Class({
    ...
    bpfCurHisStep: function () {
        ...
        if (this.backPlay.step <= 2) {
            ri.benjing = 0
            this.gameScript.benjing = 0;
        } else {
            ri.benjing = this.gameScript.benjing;
        }

        //cc.log('this.backPlay.step....'+this.backPlay.step)
    ...
    bpfToHisStep: function () {
        ...
        // if (cc.g.utils.judgeObjectEmpty(rm.benjing)) {
        //     ri.benjing = this.benjing;
        // } else {
        //     ri.benjing = this.gameScript.benjing;
        // }
