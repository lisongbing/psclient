...
cc.Class({
    ...
    onClickQiPaiBtnClicked: function(customData) {
        ...
        let handlePaiArray = this.playerView[0].handCardView.hcGroups;
        //cc.log('当前状态...')
        //cc.log('onClickQiPaiBtnClicked...', player.d.status)
        // 换3张
        // 操作
        if (player.d.status == LG_Sta.CanHuan3.v) { // 换3张操作
            ...
            // 红中，则返回 或者 显示操作按钮时候 返回
            if (qiPaiItemTwo.code == 50 || qiPaiItemTwo.zezao || qiPaiItemTwo.isAutoHu) {
                return
            }
    ...
    doAutoSelectThreePai: function (palyerViewItem) {
        ...
        //cc.log('doAutoSelectThreePai.....', canHuan)
        //cc.log('palyerViewItem.index.....', palyerViewItem.index)
    ...
    doRealQiPaiRemove: function (palyerViewItem, code) {
        ...
        let qiPaiArr = palyerViewItem.qiCardView.qiPaiArr
        //cc.log('code-->', code)
        //cc.log('qiCards-->', qiCards)
        //cc.log('qiPaiArr-->', qiPaiArr)
    ...
    doAutoHu(event) {
        ...
        //cc.log('this.isAutoHuthis.isAutoHuthis.isAutoHu->', this.isAutoHu)
