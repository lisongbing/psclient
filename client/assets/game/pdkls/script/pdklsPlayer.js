...
cc.Class({
    ...
    onOutCard: function (va, isClt) {
        ...
        if (v[0] < 0) {
            ...
            v[0]==-8 && cc.g.global.hint('不允许姊妹对');
            v[0]==-9 && cc.g.global.hint('不允许小炸');
            v[0]==-10 && cc.g.global.hint('不允许三同');
            v[0]==-11 && cc.g.global.hint('不允许炸弹');
            v[0]==-12 && cc.g.global.hint('不允许四同');
