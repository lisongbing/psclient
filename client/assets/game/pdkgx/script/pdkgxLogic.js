    ...
    */
    ...
    getCanOutCombination: function (codes, tgCodes, tgType) {
        ...
        if (tgType==ComType.DAN) {
            ...
            r = this.checkSan(ifo, 2, tgType);// 三带2
    ...
    getCodsCombination: function (codes, ctype) {
        ...
        // 四 四带一 四带二 四带三
        if (!ctype || (ctype==ComType.SID3)) {
            r = this.checkSi(ifo);
            r && com.push(r);
            if (ctype==ComType.SID3 && r) return com;
        }
    ...
    getMatchingCom: function (sourceCodes, mateCodes, ctype) {
        ...
        if (aaa) {
            if (dis.val[2] && dis.val[2].length>0) {
                aaa = [aaa[0].concat(dis.val[2][0])];
    ...
    findTake: function (sourceCodes, codes, num, same) {
        ...
        codes.forEach(e => {
            ...
            scodes.forEach(e1 => {
                ...
                // 主要处理数量问题 比如主牌里有  3 3  源牌有 3 3 3 那就还要剩一个3  不能全剔除了
                if (ctn || (e1!=e)) {
                    newsc.push(e1);
                }
