...
var MajhPlayer = require('yjmjPlayer');
var majhMsgQueue = require('yjmjMsgQueue');
var mjBackPlay = require('yjmjBackPlay');
let mjAudio = require('yjmjAudio');
...
cc.Class({
    ...
    init: function (roomInfo, player, otherPlayers) {
        ...
        if (this.gameScript != null) {
            ...
            // hidden
           // this.gameScript.hiddenSettleView()
        }
    ...
    playerStatusUpdated: function(palyer) {
        // 选牌结束 更新其他玩家状态
        if (palyer.status == DEF.RMSTA.Huan31.v) { // 3-换三张1
