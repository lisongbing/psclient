...
let MJBackPlay = cc.Class({
    ...
    initData: function () {
        ...
        for (let i = 0; i < ops.length; ++i) {
            ...
            // // 保持状态
            // if (m.op.k == DEF.PlayerOpt.Piao.v) {
            //     ri.status = DEF.RMSTA.Piao1.v
            // } else if (m.op.k == DEF.PlayerOpt.Huan3.v) {
            //     ri.status = DEF.PlayerOpt.CanHuan3.v
            // } else if (m.op.k == DEF.RMSTA.Ding1.v) {
            //     ri.status = DEF.PlayerOpt.CanDingQue.v
            // }
        ...
        */}

        {
            ...
            m.result.maValue = res.Reslut.Result.maValue;
            this.gameSettle  = m;
        }
    },
