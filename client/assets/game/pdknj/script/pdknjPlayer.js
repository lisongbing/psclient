...
cc.Class({
    ...
    initOptFun: function () {
        ...
        //天关
        kf[LG_opt.CanTianguan.v] = this.canTianguan.bind(this);
        kf[LG_opt.Tianguan.v]    = this.tianGuan.bind(this);
    ...
    dataPrepare: function () {
        ...
        if (ri.status == DEF.RMSTA.Tianguan.v) {
            this.canTg = (expand[0] == 0); // -1 不可以 0 选择天关  1 天关过 2 天关
        } else {
